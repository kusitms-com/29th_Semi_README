...
이를 검증하기 위해 2030세대를 대상으로 설문조사(n=129)와 유저인터뷰(n=00)를 진행했으며 이를 통해 대상자층의 자기이해에 대한 니즈를 확인했지만, 그들은 새로운 서비스를 사용할 만큼 자기이해에 대한 니즈를 강하게 갖고 있지 않는다는 것이 한계였습니다.

<img width="749" alt="3" src="https://github.com/KUSITMS-29th-TEAM-D/29th_Semi_README/assets/113084292/5755fdcc-b795-4e9b-bb47-99363065ebf7">

> 응답자 전체 중 107명은 본인의 강점, 선호, 적성 등 자기이해를 해야할 필요를 느낀다고 답하였습니다.

<img width="360" alt="4" src="https://github.com/KUSITMS-29th-TEAM-D/29th_Semi_README/assets/113084292/6e133463-0558-4334-a878-719132a87099">
...
**나를 브랜딩하여 알리고자하는 집단이 겪는**, 

퍼스널 브랜딩(나를 이해하고 나의 차별성을 파악하는) 과정에서, 

방향설정이 어려운 문제

<aside>
  
✅ 퍼스널 브랜딩은 [인지-탐색-구축-확산-관리]의 과정을 거치며, 셀피스는 [인지-탐색-구축] 단계에서 겪는 어려움을 해결하고자 합니다.
...
<aside>
🔥 퍼스널 브랜딩에 대한 니즈가 있는 집단이 브랜드 구축의 초기 단계에서 **나의 Core value**를 파악하는 것을 도와준다.
...
![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/ffb96dd3-1baf-4262-85b0-d0660a0d87db/f6d6a738-7df2-4dde-b67a-e57256be220d/Untitled.png)
...
![출처 : 알바몬](https://prod-files-secure.s3.us-west-2.amazonaws.com/ffb96dd3-1baf-4262-85b0-d0660a0d87db/dbf350a7-fdab-429e-83c8-46681f4c7b1c/Untitled.png)
...
![출처 : 한국전파진흥협회(’1인미디어 산업 실태조사', 2022)](https://prod-files-secure.s3.us-west-2.amazonaws.com/ffb96dd3-1baf-4262-85b0-d0660a0d87db/93562c6a-2618-496b-9ec8-5a8419e037a4/Untitled.png)

출처 : 한국전파진흥협회(’1인미디어 산업 실태조사', 2022)

![출처 : 한국전파진흥협회(’디지털크리에이터 활동현황 조사 보고서’, 2023)](https://prod-files-secure.s3.us-west-2.amazonaws.com/ffb96dd3-1baf-4262-85b0-d0660a0d87db/3c0ccb25-b56e-4af5-9073-ca79a5d07bbf/Screenshot_2024-05-01_at_08.54.42.png)

출처 : 한국전파진흥협회(’디지털크리에이터 활동현황 조사 보고서’, 2023)
...
![37.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/ffb96dd3-1baf-4262-85b0-d0660a0d87db/0ff5bd20-b891-4f9f-b0fc-c834dd5f1e57/37.png)
...
| 기능 | 설명 | 의도 |
| --- | --- | --- |
| 자기이해_Discover | 챗봇과의 대화를 통해 과거 나의 삶을 회고할 수 있는 기능  → AI챗봇과의 채팅  → 라이프디자인 기법을 기반으로 구성된 질문  → 4분면 시각화를 통한 자기이해 | 라이프디자인에 기반한, 챗봇과의 대화를 통해 회고에 사용자의 부담을 간소화 하면서도, 자연스럽게 나를 이해할 수 있도록 함. |
| 자기이해_Define | 홀랜드 검사 이론을 기반으로 설계된 질문과 태그형 답변 방식 제공 → 테스트 결과 유형에 따른 조각 카드 시각화 | 홀랜드 검사 이론을 기반으로, 가벼우면서도 유저에게 신뢰있는 방식으로 자기이해를 할 수 있도록 함. 해당 기능을 통해 흥미, 적성 등을 파악할 수 있도록 함. |
| 자기이해_Design | 유저의 이상향(퍼스널브랜드) 설정 기능 → 분야 및 키워드 선택 → 플랫폼 및 브랜드 가치 설정 | 간단한 방식으로, 퍼스널 브랜드의 방향성을 설정하고 셀피스에서 고유한 브랜드를 ‘디자인’ 하기위한 첫번째 스텝을 제공함. |
| 경험추천 | 유저가 설정한 이상향(퍼스널브랜드)에 맞는 경험 콘텐츠들을 추천 → 자기이해, 브랜딩, 콘텐츠로 세분화된 추천 → 자기이해 관련 외부 프로그램 정보 상세 열람 및 신청 기능 → 퍼스널 브랜딩 방법, 브랜드 관리와 관련된 외부 콘텐츠 큐레이션 | 카테고리를 3분야로 분할하여, 유저가 목적에 따라 추천 및 신청을 경험하도록 함. [자기이해] 자기이해에 어려움과 깊은 고찰에 대한 갈망이 있는 유저의 페인포인트를 해결하기 위함. [브랜딩] 브랜드 방향성을 정하는 과정에서, 아직 확신을 얻지 못하는 유저의 페인포인트를 해결하기 위함. [콘텐츠] 브랜드를 구축했지만, 그 브랜드를 관리하는 과정에서 어려움을 겪는 유저를 위함. |
| 대시보드 | 유저의 활동을 시각화하고 개인 정보를 관리할 수 있는 기능 → 나의 조각 유형 카드 → 유형 진단 결과 그래프 → 신청한 활동 목록 → 정보 수정 | 셀피스 내에서 활동한 기록을 한 눈에 열람할 수 있도록 함. Define 테스트를 통해 도출된 조각 유형과 그에 대한 자세한 설명을 확인할 수 있으며, 기본정보를 수정할 수 있도록 함. |
